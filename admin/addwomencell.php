...
if(isset($_POST['subm']))
{
    ...
    mysqli_query($conn,"INSERT INTO login_tb(username,password,role)VALUES('$user','$pass','womencell')");
    $id=mysqli_insert_id($conn);

    mysqli_query($conn,"INSERT INTO womencell_tb(login_id,name,location,mobile,email)VALUES('$id','$name','$location','$mobile','$email')");
...
<html lang="en">
  <head>
    ...
    <title>She Secure-Add Women Cell</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Add Women Cell</h3>
            <div class="tile-body">
