...
if(isset($_POST['subm']))
{
    $title=$_POST['title'];
    $des=$_POST['des'];
    mysqli_query($conn,"INSERT INTO primarycare_tb(tip_title,tip_description)VALUES('$title','$des')");
...
<html lang="en">
  <head>
    ...
    <title>She Secure-Add Health Tips</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Add Health Tips</h3>
            <div class="tile-body">
              <form class="form-horizontal">
                ...
                <div class="form-group row">
                  <label class="control-label col-md-3">Tip Description</label>
                  <div class="col-md-8">
                    <textarea class="form-control" type="text" placeholder="description" name="des"></textarea>
                  </div>
</div>
              </form>
            </div>
